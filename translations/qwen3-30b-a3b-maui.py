...
# Configuration
OUTPUT_DIR = "qwen3-30b-a3b-maui-awq"
GROQ_API_KEY = os.getenv("GROQ_API_KEY")  # Get API key from .env file
if not GROQ_API_KEY:
    raise ValueError("GROQ_API_KEY not found in environment variables. Please check your .env file.")
GROQ_API_URL = os.getenv("GROQ_API_URL")  # Get API key from .env file
if not GROQ_API_URL:
    raise ValueError("GROQ_API_URL not found in environment variables. Please check your .env file.")
...
def translate_text(hawaiian_text, model=MODEL):
    """
    Translate Hawaiian text to English using qwen3-30b-a3b through Maui API.
    
    Args:
        hawaiian_text (str): The Hawaiian text to translate
        model (str): The Maui model to use for translation
    ...
    payload = {
        ...
        "max_tokens": 40000   # Adjust based on your needs
    }
    ...
    for idx, row in df.iterrows():
        ...
        if translation:
            ...
            output_data = {
                ...
                "qwen3-30b-a3b-maui_translation": translation,
