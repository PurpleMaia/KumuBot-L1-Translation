...
# Configuration
OUTPUT_DIR = "deepseek-r1-distill-llama-70b"
...
def translate_text(hawaiian_text, model=MODEL):
    """
    Translate Hawaiian text to English using DeepSeek-R1-Distill-Llama-70B through Groq API.
    ...
    for idx, row in df.iterrows():
        ...
        if translation:
            ...
            output_data = {
                ...
                "deepseek-r1-distill-llama-70b_translation": translation,
