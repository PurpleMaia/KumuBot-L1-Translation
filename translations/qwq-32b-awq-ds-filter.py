...
#lcpp-nvd-unsloth-mistral-Small-3.1-24B-Instruct-2503-UD-Q4_K_XL-32k
# Load environment variables from .env file
load_dotenv()
# Configuration
OUTPUT_DIR = "qwq-32b-awq-maui"
...
MODEL = "sglang-qwq-32b-awq-40k-ds-filter"
...
def translate_text(hawaiian_text, model=MODEL):
    ...
    payload = {
        ...
        "max_tokens": 38000   # Adjust based on your needs
    }
