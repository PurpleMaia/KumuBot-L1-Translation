...
class GeminiTranslator:
    ...
    def process_dataset(self, dataframe: pd.DataFrame, hawaiian_col: str, english_col: str):
        """
...
def main():
    ...
    if hawaiian_col not in df.columns or english_col not in df.columns:
        logger.warning(f"Warning: Expected column names '{hawaiian_col}' and '{english_col}' not found.")
