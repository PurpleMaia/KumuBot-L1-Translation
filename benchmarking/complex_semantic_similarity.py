...
class MultiComponentEvaluator:
    ...
    def evaluate_component_similarity(
        ...
        for i, (model_text, ref_embedding) in enumerate(tqdm(zip(model_texts, ref_embeddings))):
    ...
    def evaluate_model(self, output_dir: str) -> Dict[str, any]:
        ...
        for component_name, (model_texts, ref_texts) in components.items():
            ...
            print(f"{component_name.title()} - Average similarity: {avg_similarity:.4f}")
    ...
    def save_results(self, results: Dict[str, any], output_dir: str):
        ...
        json_path = f"benchmarking/complex_analysis/{output_dir}_similarity_results.json"
